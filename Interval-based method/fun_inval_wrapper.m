...
for i = 1:q+1
    if i == 1
        ...
        %Interval evaluation
        Y_M = [Y_M; water_dist_fun_inval(X_all,param,type)];
        %Compute union hull
        if size(Y_M,1) >= 1
